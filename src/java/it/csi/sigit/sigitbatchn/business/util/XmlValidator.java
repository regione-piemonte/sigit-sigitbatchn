...
public class XmlValidator {
	 ...
	 * @throws XmlValidatorException Lo schema o il file XML non è valido
	 */
	public static void validate(Reader xmlReader, Reader xmlSchemaReader) throws XmlValidatorException {
		...
		if(!xml.validate(xmlOptions)) {
			exception = new XmlValidatorException("L'XML non è valido");
	 ...
	 * Valida un file XML
	 * 
	 * @param xmlInputu InputStream dell'XML da validare
	 * @param xmlSchemaReader Reader dello schema con cui validare l'XML
	 * @throws XmlValidatorException Lo schema o il file XML non è valido
	 */
	public static void validate(InputStream xmlInputu, Reader xmlSchemaReader) throws XmlValidatorException {
		XmlValidatorException exception = null;
		XmlOptions xmlOptions = null;
		Collection<XmlError> errors = null;
		SchemaTypeLoader schemaTypeLoader = null;
		...
		schemaTypeLoader = loadSchema(xmlSchemaReader);
		xml = loadXml(xmlInputu, schemaTypeLoader);
		if(xml.schemaType() == XmlObject.type) {
			log.debug("schema type non valido");
			throw new XmlValidatorException("Tipo di schema dell'XML non valido");
		}
	 ...
	 * Valida un file XML
	 * 
	 * @param xmlReader String dell'XML da validare
	 * @param xmlSchemaReader Reader dello schema con cui validare l'XML
	 * @throws XmlValidatorException Lo schema o il file XML non è valido
	 */
	public static void validate(String xmlReader, Reader xmlSchemaReader) throws XmlValidatorException {
		XmlValidatorException exception = null;
		XmlOptions xmlOptions = null;
		Collection<XmlError> errors = null;
		SchemaTypeLoader schemaTypeLoader = null;
	 ...
	 * @return XML caricato
	 * @throws XmlValidatorException L'XML non è stato trovato o non è valido
	 */
	private static XmlObject loadXml(Reader xmlReader, SchemaTypeLoader schemaTypeLoader) throws XmlValidatorException {
		...
		try {
			...
			throw new XmlValidatorException("L'XML non è valido", e);
		}
		catch(IOException e) {
	 ...
	 * Carica un XML
	 * 
	 * @param xmlInput InputStream dell'XML da caricare
	 * @param schemaTypeLoader Parsificatore di XML da utilizzare
	 * @return XML caricato
	 * @throws XmlValidatorException L'XML non è stato trovato o non è valido
	 */
	private static XmlObject loadXml(InputStream xmlInput, SchemaTypeLoader schemaTypeLoader) throws XmlValidatorException {
		XmlOptions xmlOptions = null;
		XmlObject xml = null;
		...
		xmlOptions.setLoadLineNumbers(XmlOptions.LOAD_LINE_NUMBERS_END_ELEMENT);
		try {
			xml = schemaTypeLoader.parse(xmlInput, null, xmlOptions);
		}
		catch(XmlException e) {
			throw new XmlValidatorException("L'XML non è valido", e);
		}
	 ...
	 * @throws XmlValidatorException L'XML non è stato trovato o non è valido
	 */
	private static XmlObject loadXml(String xmlReader, SchemaTypeLoader schemaTypeLoader) throws XmlValidatorException {
		XmlOptions xmlOptions = null;
		XmlObject xml = null;
...
//		}
	 ...
	 * @throws XmlValidatorException Lo schema non è stato trovato o non è
	 *             valido
	 */
	private static SchemaTypeLoader loadSchema(Reader xmlSchemaReader) throws XmlValidatorException {
		...
		try {
			...
			exception = new XmlValidatorException("Lo schema non è valido", e);
			exception.setErrors(errors);
			throw exception;
		}
		catch(IOException e) {
