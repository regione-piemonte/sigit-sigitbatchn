...
public class Mail implements java.io.Serializable {
	...
	private Hashtable<String, ByteArrayOutputStream> _attachmentList = null;
	
	public Hashtable<String, ByteArrayOutputStream> getAttachmentList() {
		return _attachmentList;
	}

	public void setAttachmentList(Hashtable<String, ByteArrayOutputStream> attachmentList) {
