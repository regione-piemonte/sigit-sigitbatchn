...
/**
 * RowMapper specifico del DAO SigitVCompTeDao
 * @generated
 */
public class SigitVCompTeDaoRowMapper extends BaseDaoRowMapper implements org.springframework.jdbc.core.RowMapper {

	/**
	 * Dao associato al RowMapper. Serve per i supplier DAO
	 * @generated
	 */
	SigitVCompTeDaoImpl dao;
	 ...
	 */
	public SigitVCompTeDaoRowMapper(String[] columnsToRead, Class dtoClass, SigitVCompTeDao dao) {
		super(columnsToRead, dtoClass);
		this.dao = (SigitVCompTeDaoImpl) dao;
	}
	 ...
	 * @param row
	 * @throws SQLException
	 * @return SigitVCompTeDto
	 * @generated
	 */
	public Object mapRow(ResultSet rs, int row) throws SQLException {
		Object dtoInstance = getNewDto();

		if (dtoInstance instanceof SigitVCompTeDto) {
			return mapRow_internal((SigitVCompTeDto) dtoInstance, rs, row);
		}

		return dtoInstance;
	}

	public SigitVCompTeDto mapRow_internal(SigitVCompTeDto objectToFill, ResultSet rs, int row) throws SQLException {
		SigitVCompTeDto dto = objectToFill;
