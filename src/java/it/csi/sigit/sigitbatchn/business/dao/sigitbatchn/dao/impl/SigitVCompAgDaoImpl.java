...
/*PROTECTED REGION ID(R-1740147501) ENABLED START*/
...
public class SigitVCompAgDaoImpl extends AbstractDAO implements SigitVCompAgDao {
	...
	public List<SigitVCompAgDto> findByCodImpiantoOrdered(Integer input) throws SigitVCompAgDaoException {
		...
		sql.append(" WHERE ");
		/*PROTECTED REGION ID(R626858444) ENABLED START*/
		...
		/*PROTECTED REGION END*/
		/*PROTECTED REGION ID(R-1917338466) ENABLED START*/
