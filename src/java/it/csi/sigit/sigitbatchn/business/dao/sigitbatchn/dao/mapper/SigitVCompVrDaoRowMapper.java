...
/**
 * RowMapper specifico del DAO SigitVCompVrDao
 * @generated
 */
public class SigitVCompVrDaoRowMapper extends BaseDaoRowMapper implements org.springframework.jdbc.core.RowMapper {

	/**
	 * Dao associato al RowMapper. Serve per i supplier DAO
	 * @generated
	 */
	SigitVCompVrDaoImpl dao;
	 ...
	 */
	public SigitVCompVrDaoRowMapper(String[] columnsToRead, Class dtoClass, SigitVCompVrDao dao) {
		super(columnsToRead, dtoClass);
		this.dao = (SigitVCompVrDaoImpl) dao;
	}
	 ...
	 * @param row
	 * @throws SQLException
	 * @return SigitVCompVrDto
	 * @generated
	 */
	public Object mapRow(ResultSet rs, int row) throws SQLException {
		Object dtoInstance = getNewDto();

		if (dtoInstance instanceof SigitVCompVrDto) {
			return mapRow_internal((SigitVCompVrDto) dtoInstance, rs, row);
		}

		return dtoInstance;
	}

	public SigitVCompVrDto mapRow_internal(SigitVCompVrDto objectToFill, ResultSet rs, int row) throws SQLException {
		SigitVCompVrDto dto = objectToFill;
