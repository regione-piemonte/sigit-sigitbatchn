...
/**
 * Primary Key del DTO SigitRAllegatoCompScDto.
 * E' utilizzato per tutte le operazioni di lettura dati per chiave primaria. 
 * @generated
 */
public class SigitRAllegatoCompScPk implements Serializable {
	...
	/**
	 * Method 'equals'. 
	 * Due istanze di SigitRAllegatoCompScPk sono equals se i valori di tutti i campi coincidono.
	 * 
	 * @param _other
	...
	public boolean equals(Object _other) {
		...
		if (!(_other instanceof SigitRAllegatoCompScPk)) {
			return false;
		}

		final SigitRAllegatoCompScPk _cast = (SigitRAllegatoCompScPk) _other;
	...
	public String toString() {
		...
		ret.append("it.csi.sigit.sigitbatchn.business.dao.sigitbatchn.dto.SigitRAllegatoCompScPk: ");
