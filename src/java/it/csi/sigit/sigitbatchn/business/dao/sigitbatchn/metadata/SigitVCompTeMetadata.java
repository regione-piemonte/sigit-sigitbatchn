 ...
 * @generated
 */
public class SigitVCompTeMetadata extends DAOMetadata {
	 ...
	 * DAO: [sigitVCompTe]
	 * tabella: [VISTA_COMP_TE].
	 */
	public SigitVCompTeMetadata() {
		columnNames = new String[]{"CODICE_IMPIANTO", "ID_TIPO_COMPONENTE", "DATA_INSTALL", "PROGRESSIVO",
				...
				"CAPACITA_L", "FLG_DISMISSIONE"};
		propertyNames = new String[]{"codiceImpianto", "idTipoComponente", "dataInstall", "progressivo", "dataDismiss",
				"matricola", "fkMarca", "desMarca", "modello", "numVentilatori", "tipoVentilatori", "capacitaL",
				"flgDismissione"};
	...
	/**
	 * Method 'getTableName'
	 * Restituisce il nome della tabella a cui il DAO [sigitVCompTe] fa riferimento
	 * (VISTA_COMP_TE).
	 * @return String
	 * @generated
	 */
