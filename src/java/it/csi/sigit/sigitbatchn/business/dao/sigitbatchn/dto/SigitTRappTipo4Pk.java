...
/**
 * Primary Key del DTO SigitTRappTipo4Dto.
 * E' utilizzato per tutte le operazioni di lettura dati per chiave primaria. 
 * @generated
 */
public class SigitTRappTipo4Pk implements Serializable {
	...
	/**
	 * Method 'equals'. 
	 * Due istanze di SigitTRappTipo4Pk sono equals se i valori di tutti i campi coincidono.
	 * 
	 * @param _other
	...
	public boolean equals(Object _other) {
		...
		if (!(_other instanceof SigitTRappTipo4Pk)) {
			return false;
		}

		final SigitTRappTipo4Pk _cast = (SigitTRappTipo4Pk) _other;
	...
	public String toString() {
		...
		ret.append("it.csi.sigit.sigitbatchn.business.dao.sigitbatchn.dto.SigitTRappTipo4Pk: ");
