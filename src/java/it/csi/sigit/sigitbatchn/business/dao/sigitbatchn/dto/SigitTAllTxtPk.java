...
/**
 * Primary Key del DTO SigitTAllTxtDto.
 * E' utilizzato per tutte le operazioni di lettura dati per chiave primaria. 
 * @generated
 */
public class SigitTAllTxtPk implements Serializable {
	...
	/**
	 * Method 'equals'. 
	 * Due istanze di SigitTAllTxtPk sono equals se i valori di tutti i campi coincidono.
	 * 
	 * @param _other
	...
	public boolean equals(Object _other) {
		...
		if (!(_other instanceof SigitTAllTxtPk)) {
			return false;
		}

		final SigitTAllTxtPk _cast = (SigitTAllTxtPk) _other;
	...
	public String toString() {
		...
		ret.append("it.csi.sigit.sigitbatchn.business.dao.sigitbatchn.dto.SigitTAllTxtPk: ");
