...
public class SigitTPersonaFisicaDaoRowMapper extends BaseDaoRowMapper
	...
	public Object mapRow(ResultSet rs, int row) throws SQLException {
		...
		if (dtoInstance instanceof SigitTPersonaFisicaEmailPfImportDto) {
			return mapRow_internal((SigitTPersonaFisicaEmailPfImportDto) dtoInstance, rs, row);
		}
	...
	/**
	 * Metodo specifico di mapping relativo al DTO custom SigitTPersonaFisicaEmailPfImportDto.
	 * 
	 * @param rs
	 * @param row
	 * @throws SQLException
	 * @return SigitTPersonaFisicaEmailPfImportDto
	 * @generated
	 */

	public SigitTPersonaFisicaEmailPfImportDto mapRow_internal(SigitTPersonaFisicaEmailPfImportDto objectToFill,
			ResultSet rs, int row) throws SQLException {
		SigitTPersonaFisicaEmailPfImportDto dto = objectToFill;

		if (mapAllColumns || columnsToReadMap.get("EMAIL") != null)
			dto.setPfEmail(rs.getString("EMAIL"));
