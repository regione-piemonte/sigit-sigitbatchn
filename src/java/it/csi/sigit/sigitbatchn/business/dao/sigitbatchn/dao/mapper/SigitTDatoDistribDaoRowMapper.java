...
public class SigitTDatoDistribDaoRowMapper extends BaseDaoRowMapper implements org.springframework.jdbc.core.RowMapper {
	...
	public Object mapRow(ResultSet rs, int row) throws SQLException {
		...
		if (dtoInstance instanceof SigitTDatoDistribAllByIdStatoImportDistribDto) {
			return mapRow_internal((SigitTDatoDistribAllByIdStatoImportDistribDto) dtoInstance, rs, row);
		}
	...
	/**
	 * Metodo specifico di mapping relativo al DTO custom SigitTDatoDistribAllByIdStatoImportDistribDto.
	 * 
	 * @param rs
	 * @param row
	 * @throws SQLException
	 * @return SigitTDatoDistribAllByIdStatoImportDistribDto
	 * @generated
	 */

	public SigitTDatoDistribAllByIdStatoImportDistribDto mapRow_internal(
			SigitTDatoDistribAllByIdStatoImportDistribDto objectToFill, ResultSet rs, int row) throws SQLException {
		SigitTDatoDistribAllByIdStatoImportDistribDto dto = objectToFill;

		if (mapAllColumns || columnsToReadMap.get("ID_DATO_DISTRIB") != null)
			dto.setDdIdDatoDistrib((Integer) rs.getObject("ID_DATO_DISTRIB"));
