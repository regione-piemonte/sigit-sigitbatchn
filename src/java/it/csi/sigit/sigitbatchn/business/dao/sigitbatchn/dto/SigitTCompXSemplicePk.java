...
/**
 * Primary Key del DTO SigitTCompXSempliceDto.
 * E' utilizzato per tutte le operazioni di lettura dati per chiave primaria. 
 * @generated
 */
public class SigitTCompXSemplicePk implements Serializable {
	...
	/**
	 * Method 'equals'. 
	 * Due istanze di SigitTCompXSemplicePk sono equals se i valori di tutti i campi coincidono.
	 * 
	 * @param _other
	...
	public boolean equals(Object _other) {
		...
		if (!(_other instanceof SigitTCompXSemplicePk)) {
			return false;
		}

		final SigitTCompXSemplicePk _cast = (SigitTCompXSemplicePk) _other;
	...
	public String toString() {
		...
		ret.append("it.csi.sigit.sigitbatchn.business.dao.sigitbatchn.dto.SigitTCompXSemplicePk: ");
