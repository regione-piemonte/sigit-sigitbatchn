...
/**
 * Primary Key del DTO SigitTLibTxtDto.
 * E' utilizzato per tutte le operazioni di lettura dati per chiave primaria. 
 * @generated
 */
public class SigitTLibTxtPk implements Serializable {
	...
	/**
	 * Method 'equals'. 
	 * Due istanze di SigitTLibTxtPk sono equals se i valori di tutti i campi coincidono.
	 * 
	 * @param _other
	...
	public boolean equals(Object _other) {
		...
		if (!(_other instanceof SigitTLibTxtPk)) {
			return false;
		}

		final SigitTLibTxtPk _cast = (SigitTLibTxtPk) _other;
	...
	public String toString() {
		...
		ret.append("it.csi.sigit.sigitbatchn.business.dao.sigitbatchn.dto.SigitTLibTxtPk: ");
