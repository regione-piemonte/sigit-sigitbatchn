...
/**
 * Primary Key del DTO SigitTImpiantoDto.
 * E' utilizzato per tutte le operazioni di lettura dati per chiave primaria. 
 * @generated
 */
public class SigitTImpiantoPk implements Serializable {
	...
	/**
	 * Method 'equals'. 
	 * Due istanze di SigitTImpiantoPk sono equals se i valori di tutti i campi coincidono.
	 * 
	 * @param _other
	...
	public boolean equals(Object _other) {
		...
		if (!(_other instanceof SigitTImpiantoPk)) {
			return false;
		}

		final SigitTImpiantoPk _cast = (SigitTImpiantoPk) _other;
	...
	public String toString() {
		...
		ret.append("it.csi.sigit.sigitbatchn.business.dao.sigitbatchn.dto.SigitTImpiantoPk: ");
