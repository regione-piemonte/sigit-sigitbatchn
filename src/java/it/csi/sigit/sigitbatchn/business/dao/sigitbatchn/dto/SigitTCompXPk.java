...
/**
 * Primary Key del DTO SigitTCompXDto.
 * E' utilizzato per tutte le operazioni di lettura dati per chiave primaria. 
 * @generated
 */
public class SigitTCompXPk implements Serializable {
	...
	/**
	 * Method 'equals'. 
	 * Due istanze di SigitTCompXPk sono equals se i valori di tutti i campi coincidono.
	 * 
	 * @param _other
	...
	public boolean equals(Object _other) {
		...
		if (!(_other instanceof SigitTCompXPk)) {
			return false;
		}

		final SigitTCompXPk _cast = (SigitTCompXPk) _other;
	...
	public String toString() {
		...
		ret.append("it.csi.sigit.sigitbatchn.business.dao.sigitbatchn.dto.SigitTCompXPk: ");
