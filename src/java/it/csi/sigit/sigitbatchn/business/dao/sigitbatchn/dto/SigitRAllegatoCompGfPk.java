...
/**
 * Primary Key del DTO SigitRAllegatoCompGfDto.
 * E' utilizzato per tutte le operazioni di lettura dati per chiave primaria. 
 * @generated
 */
public class SigitRAllegatoCompGfPk implements Serializable {
	...
	/**
	 * Method 'equals'. 
	 * Due istanze di SigitRAllegatoCompGfPk sono equals se i valori di tutti i campi coincidono.
	 * 
	 * @param _other
	...
	public boolean equals(Object _other) {
		...
		if (!(_other instanceof SigitRAllegatoCompGfPk)) {
			return false;
		}

		final SigitRAllegatoCompGfPk _cast = (SigitRAllegatoCompGfPk) _other;
	...
	public String toString() {
		...
		ret.append("it.csi.sigit.sigitbatchn.business.dao.sigitbatchn.dto.SigitRAllegatoCompGfPk: ");
