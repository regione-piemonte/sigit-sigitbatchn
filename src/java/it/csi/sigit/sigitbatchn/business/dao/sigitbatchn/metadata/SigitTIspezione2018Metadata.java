...
public class SigitTIspezione2018Metadata extends DAOMetadata {
	...
	public SigitTIspezione2018Metadata() {
		columnNames = new String[]{"ID_ISPEZIONE_2018", "FK_STATO_ISPEZIONE", "FK_VERIFICA", "FK_ACCERTAMENTO",
				"CODICE_IMPIANTO", "CF_ISPETTORE_SECONDARIO", "DT_CREAZIONE", "ENTE_COMPETENTE", "FLG_ESITO",
				"DT_SVEGLIA", "NOTE_SVEGLIA", "NOTE", "DT_CONCLUSIONE", "ISTAT_PROV_COMPETENZA", "FLG_ACC_SOSTITUTIVO",
				"FLG_ISP_PAGAMENTO"};
		propertyNames = new String[]{"idIspezione2018", "fkStatoIspezione", "fkVerifica", "fkAccertamento",
				"codiceImpianto", "cfIspettoreSecondario", "dtCreazione", "enteCompetente", "flgEsito", "dtSveglia",
				"noteSveglia", "note", "dtConclusione", "istatProvCompetenza", "flgAccSostitutivo", "flgIspPagamento"};
