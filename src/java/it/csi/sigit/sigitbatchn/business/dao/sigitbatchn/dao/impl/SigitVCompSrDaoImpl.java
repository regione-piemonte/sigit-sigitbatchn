...
/*PROTECTED REGION ID(R296521605) ENABLED START*/
...
public class SigitVCompSrDaoImpl extends AbstractDAO implements SigitVCompSrDao {
	...
	public List<SigitVCompSrDto> findByCodImpiantoOrdered(Integer input) throws SigitVCompSrDaoException {
		...
		sql.append(" WHERE ");
		/*PROTECTED REGION ID(R-660926349) ENABLED START*/
		...
		/*PROTECTED REGION END*/
		/*PROTECTED REGION ID(R1111005911) ENABLED START*/
