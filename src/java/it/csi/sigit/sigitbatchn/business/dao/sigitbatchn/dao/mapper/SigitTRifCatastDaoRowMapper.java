...
public class SigitTRifCatastDaoRowMapper extends BaseDaoRowMapper implements org.springframework.jdbc.core.RowMapper {
	...
	public Object mapRow(ResultSet rs, int row) throws SQLException {
		...
		if (dtoInstance instanceof SigitTRifCatastAllByIdStatoImportDistribDto) {
			return mapRow_internal((SigitTRifCatastAllByIdStatoImportDistribDto) dtoInstance, rs, row);
		}
	...
	/**
	 * Metodo specifico di mapping relativo al DTO custom SigitTRifCatastAllByIdStatoImportDistribDto.
	 * 
	 * @param rs
	 * @param row
	 * @throws SQLException
	 * @return SigitTRifCatastAllByIdStatoImportDistribDto
	 * @generated
	 */

	public SigitTRifCatastAllByIdStatoImportDistribDto mapRow_internal(
			SigitTRifCatastAllByIdStatoImportDistribDto objectToFill, ResultSet rs, int row) throws SQLException {
		SigitTRifCatastAllByIdStatoImportDistribDto dto = objectToFill;

		if (mapAllColumns || columnsToReadMap.get("ID_RIF_CATAST") != null)
			dto.setRcIdRifCatast((Integer) rs.getObject("ID_RIF_CATAST"));
