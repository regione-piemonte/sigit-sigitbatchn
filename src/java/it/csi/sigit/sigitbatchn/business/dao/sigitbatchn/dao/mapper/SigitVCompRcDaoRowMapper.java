...
/**
 * RowMapper specifico del DAO SigitVCompRcDao
 * @generated
 */
public class SigitVCompRcDaoRowMapper extends BaseDaoRowMapper implements org.springframework.jdbc.core.RowMapper {

	/**
	 * Dao associato al RowMapper. Serve per i supplier DAO
	 * @generated
	 */
	SigitVCompRcDaoImpl dao;
	 ...
	 */
	public SigitVCompRcDaoRowMapper(String[] columnsToRead, Class dtoClass, SigitVCompRcDao dao) {
		super(columnsToRead, dtoClass);
		this.dao = (SigitVCompRcDaoImpl) dao;
	}
	 ...
	 * @param row
	 * @throws SQLException
	 * @return SigitVCompRcDto
	 * @generated
	 */
	public Object mapRow(ResultSet rs, int row) throws SQLException {
		Object dtoInstance = getNewDto();

		if (dtoInstance instanceof SigitVCompRcDto) {
			return mapRow_internal((SigitVCompRcDto) dtoInstance, rs, row);
		}

		return dtoInstance;
	}

	public SigitVCompRcDto mapRow_internal(SigitVCompRcDto objectToFill, ResultSet rs, int row) throws SQLException {
		SigitVCompRcDto dto = objectToFill;
