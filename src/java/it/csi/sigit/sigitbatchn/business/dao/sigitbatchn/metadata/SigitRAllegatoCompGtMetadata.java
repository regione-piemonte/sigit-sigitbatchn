 ...
 * @generated
 */
public class SigitRAllegatoCompGtMetadata extends DAOMetadata {
	 ...
	 * DAO: [sigitRAllegatoCompGt]
	 * tabella: [SIGIT_R_ALLEGATO_COMP_GT].
	 */
	public SigitRAllegatoCompGtMetadata() {
	...
	/**
	 * Method 'getTableName'
	 * Restituisce il nome della tabella a cui il DAO [sigitRAllegatoCompGt] fa riferimento
	 * (SIGIT_R_ALLEGATO_COMP_GT).
	 * @return String
	 * @generated
	 */
