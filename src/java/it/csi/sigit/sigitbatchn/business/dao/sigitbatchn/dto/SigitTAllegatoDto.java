...
/**
 * Data transfer object relativo al DAO SigitTAllegatoDao.
 * @generated
 */
public class SigitTAllegatoDto extends SigitTAllegatoPk {
	...
	/**
	 * Crea una istanza di SigitTAllegatoPk a partire dal valore dei campi chiave del DTO
	 * 
	 * @return SigitTAllegatoPk
	 * @generated
	 */
	public SigitTAllegatoPk createPk() {
		return new SigitTAllegatoPk(idAllegato);
	}
